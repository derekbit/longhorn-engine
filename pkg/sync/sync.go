...
func (t *Task) AddRestoreReplica(replica string) error {
	...
	if volume.ReplicaCount == 0 {
		return t.client.VolumeStart(volume.Size, volume.Size, volume.SectorSize, replica)
	}
...
func (t *Task) StartWithReplicas(volumeSize, volumeCurrentSize, sectorSize int64, replicas []string) error {
	volume, err := t.client.VolumeGet()
	if err != nil {
		return err
	}
	...
	return t.client.VolumeStart(volumeSize, volumeCurrentSize, sectorSize, replicas...)
}
