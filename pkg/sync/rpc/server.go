...
func (s *SyncAgentServer) SnapshotHashInProgressTasks(ctx context.Context, req *empty.Empty) (*ptypes.SnapshotHashInProgressTasksResponse, error) {
	numTasks, err := replica.GetSnapshotHashInProgressTasks()
	return &ptypes.SnapshotHashInProgressTasksResponse{
