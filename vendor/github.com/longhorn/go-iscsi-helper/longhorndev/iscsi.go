...
type LonghornIscsiDevice struct {
	*sync.RWMutex
...
func (ldc *LonghornDeviceCreator) NewIscsiBlockDevice(name string, size int64, frontend string, scsiTimeout, iscsiAbortTimeout, iscsiTargetRequestTimeout int64) (DeviceService, error) {
	if name == "" || size == 0 {
		return nil, fmt.Errorf("invalid parameter for creating Longhorn device")
	}
	dev := &LonghornIscsiDevice{
...
func (d *LonghornIscsiDevice) InitDevice() error {
	d.Lock()
	defer d.Unlock()
...
// call with lock hold
func (d *LonghornIscsiDevice) initScsiDevice() error {
...
func (d *LonghornIscsiDevice) Start() error {
...
func (d *LonghornIscsiDevice) startScsiDevice(startScsiDevice bool) (err error) {
	d.Lock()
	defer d.Unlock()
...
func (d *LonghornIscsiDevice) Shutdown() error {
	d.Lock()
	defer d.Unlock()
...
// call with lock hold
func (d *LonghornIscsiDevice) shutdownFrontend() error {
	switch d.frontend {
	case types.FrontendTGTBlockDev:
		dev := d.getDev()
...
func (d *LonghornIscsiDevice) WaitForSocket(stopCh chan struct{}) chan error {
...
func (d *LonghornIscsiDevice) GetSocketPath() string {
	return filepath.Join(SocketDirectory, "longhorn-"+d.name+".sock")
}

// call with lock hold
func (d *LonghornIscsiDevice) getDev() string {
	return filepath.Join(DevPath, d.name)
}

// call with lock hold
func (d *LonghornIscsiDevice) createDev() error {
...
func (d *LonghornIscsiDevice) PrepareUpgrade() error {
	if d.frontend == "" {
		return nil
	}
...
func (d *LonghornIscsiDevice) FinishUpgrade() (err error) {
	if d.frontend == "" {
		return nil
	}
...
func (d *LonghornIscsiDevice) ReloadSocketConnection() error {
	d.RLock()
	dev := d.getDev()
	d.RUnlock()
...
func (d *LonghornIscsiDevice) SetFrontend(frontend string) error {
...
func (d *LonghornIscsiDevice) UnsetFrontendCheck() error {
	d.Lock()
	defer d.Unlock()
...
func (d *LonghornIscsiDevice) UnsetFrontend() {
	d.Lock()
	defer d.Unlock()
...
func (d *LonghornIscsiDevice) Enabled() bool {
	d.RLock()
	defer d.RUnlock()
	return d.scsiDevice != nil
}

func (d *LonghornIscsiDevice) GetEndpoint() string {
	d.RLock()
	defer d.RUnlock()
	return d.endpoint
}

func (d *LonghornIscsiDevice) GetFrontend() string {
	d.RLock()
	defer d.RUnlock()
	return d.frontend
}

func (d *LonghornIscsiDevice) Expand(size int64) (err error) {
	d.Lock()
	defer d.Unlock()
